...
const DeleteWithdraw: React.FunctionComponent<
EditPieceProps
> = ({ showDeleteModal, setShowDeleteModal,withdrawName,withdrawId }) => {



  const onSubmit = () => {
    instance.delete(ApiHelper.get("BankAccounts") + "/" + withdrawId).then((res:any) => {
        if(res) {
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 pb-8 px-10 py-5">
        <div className='col-span-3'>
            ...
            <span className='text-blue-500'> {withdrawName} </span>
            <span> </span>
