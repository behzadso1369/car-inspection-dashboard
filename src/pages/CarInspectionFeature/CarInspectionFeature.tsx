...
import CreateSlider from './CreateCarInspectionFeature';
import DeleteSlider from './DeleteCarInspectionFeature';
import { NavLink } from 'react-router-dom';
import CreateBlogCategory from './CreateCarInspectionFeature';
import EditBlogCategory from './EditCarInspectionFeature';
import CreateCarInspectionSrvice from './CreateCarInspectionFeature';
import DeleteCarInspectionSrvice from './DeleteCarInspectionFeature';
import EditCarInspectionSrvice from './EditCarInspectionFeature';
...
maxWidth:80,
  ...
  return (
    <Fragment>
      <ListPageShell
        title="ویژگی های نوع کارشناسی خودرو"
        headerAction={
          <button
...
export default CarInspectionFeature;
