...
const CreateCarInspectionFeature: React.FunctionComponent<
EditPieceProps
> = ({ showAddUserModal, setShowAddUserModal }) => {
  ...
  instance.post(ApiHelper.get("CreateCarInspectionFeature"),formData).then((res:any) => {
    if(res.data) {
  ...
  return (
    ...
    >
      <DialogTitle className="w-full flex items-center gap-3 border-b !py-3 px-4">
        <span>اضافه کردن      ویژگی  نوع کارشناسی خودرو </span>
...
export default CreateCarInspectionFeature;
