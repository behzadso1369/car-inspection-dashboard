...
const EditCarInspectionDateType: React.FunctionComponent<
EditPieceProps
> = ({ showEditModal, setShowEditModal,secretOfOurServiceQualityId,secretOfOurServiceQualityName }) => {
  ...
  const onSubmit = () => {
    ...
    formData.append("maxMinutes",getValues()["maxMinutes"])
    formData.append("additionalCost",getValues()["additionalCost"]);
    formData.append("inspectionTypeDescription",getValues()["inspectionTypeDescription"]);
  instance.put(ApiHelper.get("EditCarInspectionDateType")+ "?id=" + secretOfOurServiceQualityId,formData).then((res:any) => {
    if(res.data) {
  ...
  const  getBlogTagById = () => {
    instance.get(ApiHelper.get("GetCarInspectionDateType"),{params:{id:secretOfOurServiceQualityId}}).then((res:any) => {
        reset({
          name:res.data.resultObject.name,
          maxMinutes:res.data.resultObject.maxMinutes,
...
export default EditCarInspectionDateType;
