...
const EditFinancialExpenditure: React.FunctionComponent<
EditPieceProps
> = ({ showEditModal, setShowEditModal,secretOfOurServiceQualityId,secretOfOurServiceQualityName }) => {
  ...
  instance.put(ApiHelper.get("EdtiFinancialExpenditure")+ "?id=" + secretOfOurServiceQualityId,getValues()).then((res:any) => {
    if(res.data) {
...
export default EditFinancialExpenditure;
