...
import CreateSlider from './CreateDateAndTime';
import DeleteSlider from './DeleteDateAndTime';
import { NavLink } from 'react-router-dom';
import CreateBlogCategory from './CreateDateAndTime';
import EditBlogCategory from './EditDateAndTime';
import CreateCarInspectionSrvice from './CreateDateAndTime';
import DeleteCarInspectionSrvice from './DeleteDateAndTime';
import EditCarInspectionSrvice from './EditDateAndTime';
import {Image} from "antd";
import CreateSecretOfOurServiceQuality from './CreateDateAndTime';
import DeleteSecretOfOurServiceQuality from './DeleteDateAndTime';
import EditSecretOfOurServiceQuality from './EditDateAndTime';
const DateAndTime: React.FunctionComponent = () => {
