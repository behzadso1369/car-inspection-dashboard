...
const DeleteMasterSiteDetail: React.FunctionComponent<
EditPieceProps
> = ({ showDeleteModal, setShowDeleteModal,secretOfOurServiceQualityName,secretOfOurServiceQualityId }) => {
  ...
  const onSubmit = () => {
    instance.delete(ApiHelper.get("DeleteMasterSiteDetail")+ "?id=" + secretOfOurServiceQualityId).then((res:any) => {
        if(res) {
...
export default DeleteMasterSiteDetail;
