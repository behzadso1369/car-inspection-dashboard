...
import CreateSlider from './CreateFlowLifeCycle';
import DeleteSlider from './DeleteFlowLifeCycle';
import { NavLink } from 'react-router-dom';
import CreateBlogCategory from './CreateFlowLifeCycle';
import EditBlogCategory from './EditFlowLifeCycle';
import CreateCarInspectionSrvice from './CreateFlowLifeCycle';
import DeleteCarInspectionSrvice from './DeleteFlowLifeCycle';
import EditCarInspectionSrvice from './EditFlowLifeCycle';
import {Image} from "antd";
import CreateSecretOfOurServiceQuality from './CreateFlowLifeCycle';
import DeleteSecretOfOurServiceQuality from './DeleteFlowLifeCycle';
import EditSecretOfOurServiceQuality from './EditFlowLifeCycle';
const FlowLifeCycle: React.FunctionComponent = () => {
