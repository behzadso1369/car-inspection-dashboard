...
const CreateCarGroup: React.FunctionComponent<
EditPieceProps
> = ({ showAddUserModal, setShowAddUserModal }) => {
  ...
  const getBrands = () => {
      instance.get(ApiHelper.get("CarBrandList"),{params: {skip:0,take:100000}}).then((res:any) => {
    if(res.data) {
        setBrands(res.data.resultObject);
    }
  })
  }
  ...
  return (
    ...
    >
      <DialogTitle className="w-full flex items-center gap-3 border-b !py-3 px-4">
        <span>اضافه کردن     گروه خودرو </span>
