...
const SellOrder: React.FunctionComponent = () => {
  ...
  const columnDefs:ColDef[] = [
        ...
        },
    {
      ...
      cellRenderer: (params:any) => {
        return (
          <>
          {<button className='bg-red-500 text-white text-xs py-2 cursor-pointer mr-2 rounded-md px-2  outline-none '>فروش</button>}
          </>
        )
