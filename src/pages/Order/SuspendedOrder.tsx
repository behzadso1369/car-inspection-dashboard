...
const SuspendedOrder: React.FunctionComponent = () => {
  ...
  const columnDefs:ColDef[] = [
    ...
    },
    {
      ...
      cellRenderer: (params:any) => {
        return (
          <>
          {params.data.account ? <span className='text-base'>{params.data.account}</span> :<button className='bg-slate-400 text-xs py-2 cursor-pointer mr-2 rounded-md px-2  outline-none text-black'>ثبت نشده است</button>}
          </>
        )
