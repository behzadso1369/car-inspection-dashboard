...
const VolumeSellMonthChart: React.FunctionComponent<PieceName> = () => {
    ...
    <div className="card mt-3 ml-7">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
             <div className='text-xs h-full flex '>   حجم فروش براساس ماه</div>
...
export default VolumeSellMonthChart;
