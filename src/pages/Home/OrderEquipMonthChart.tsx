...
const OrderEquipMonthChart: React.FunctionComponent<PieceName> = () => {
  ...
  useEffect(() => {
    ...
    const subscription = watch(() => {
      ...
      setLabel(dataOptions.monthOptions.filter((item:any) => item.id === getValues().orderMonth)[0].title);
    ...
    <div className="card mt-3 ml-7">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
             <div className='text-xs h-full flex '>تعداد سفارش هر قطعه براساس ماه</div>
          ...
          <Dropdown
                ...
                title="orderMonth"
                label={''}
                option={dataOptions.monthOptions}
                fullWidth={false}
              />
        </div>
...
export default OrderEquipMonthChart;
