...
const OrderEquipSessionChart: React.FunctionComponent<PieceName> = () => {
  ...
  useEffect(() => {
    ...
    const subscription = watch(() => {
      ...
      setLabel(dataOptions.sessionOptions.filter((item:any) => item.id === getValues().orderMonth)[0].title);
    ...
    <div className="card mt-3 ml-7">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
             <div className='text-xs h-full flex '>تعداد سفارش هر قطعه براساس فصل</div>
          ...
          <Dropdown
                ...
                title="orderMonth"
                label={''}
                option={dataOptions.sessionOptions}
                fullWidth={false}
              />
        </div>
...
export default OrderEquipSessionChart;
