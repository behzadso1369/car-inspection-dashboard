...
const DelayEquipChart: React.FunctionComponent<PieceName> = () => {
  ...
  const [chartData,setChartData] = useState<any>([ 15, 25, 10, 5, 35,5,5]);
...
//   };
  ...
  useEffect(() => {
    ...
    const subscription = watch(() => {
      ...
      setChartData([getRandomInt(0,80),getRandomInt(0,80),getRandomInt(0,80),getRandomInt(0,80),getRandomInt(0,80),getRandomInt(0,80),getRandomInt(0,80)])
    ...
    <div className="card mt-3 ml-7">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
             <div className='text-xs h-full flex '>    درصد تاخیر هر قطعه    </div>
...
export default DelayEquipChart;
