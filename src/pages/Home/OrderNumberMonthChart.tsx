...
const OrderNumberMonthChart: React.FunctionComponent<PieceName> = () => {
    ...
    <div className="card mt-3 ml-7">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
             <div className='text-xs h-full flex '>تعداد کل سفارشات براساس ماه</div>
...
export default OrderNumberMonthChart;
