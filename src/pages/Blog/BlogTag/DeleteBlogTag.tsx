...
const DeleteBlogTag: React.FunctionComponent<
EditPieceProps
> = ({ showDeleteModal, setShowDeleteModal,blogTagName,blogTagId }) => {



  const onSubmit = () => {
    instance.delete(ApiHelper.get("DeleteBlogTag") + "?id=" + blogTagId).then((res:any) => {
        if(res) {
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-3 pb-8 px-10 py-5">
        <div className='col-span-3'>
            <span>آیا از حذف تگ</span>
            <span className='text-blue-500'> {blogTagName} </span>
            <span> </span>
