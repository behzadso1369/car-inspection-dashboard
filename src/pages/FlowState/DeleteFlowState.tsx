...
const DeleteFlowState: React.FunctionComponent<
EditPieceProps
> = ({ showDeleteModal, setShowDeleteModal,secretOfOurServiceQualityName,secretOfOurServiceQualityId }) => {
  ...
  const onSubmit = () => {
    instance.delete(ApiHelper.get("DeleteFlowState")+ "?id=" + secretOfOurServiceQualityId).then((res:any) => {
        if(res) {
...
export default DeleteFlowState;
