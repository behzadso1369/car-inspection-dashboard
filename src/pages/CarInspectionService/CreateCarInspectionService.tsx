...
const CreateCarInspectionSrvice: React.FunctionComponent<
EditPieceProps
> = ({ showAddUserModal, setShowAddUserModal }) => {
  ...
  const onSubmit = () => {
    ...
    // }
  instance.post(ApiHelper.get("CreateCarInspectionService"),formData).then((res:any) => {
    if(res.data) {
  ...
  return (
    ...
    >
      <DialogTitle className="w-full flex items-center gap-3 border-b !py-3 px-4">
        <span>اضافه کردن    خدمت جدید </span>
...
export default CreateCarInspectionSrvice;
