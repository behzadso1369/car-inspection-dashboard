...
import CreateSlider from './CreateCarBrand';
import DeleteSlider from './DeleteCarBrand';
import { NavLink } from 'react-router-dom';
import CreateBlogCategory from './CreateCarBrand';
import EditBlogCategory from './EditCarBrand';
import CreateCarInspectionSrvice from './CreateCarBrand';
import DeleteCarInspectionSrvice from './DeleteCarBrand';
import EditCarInspectionSrvice from './EditCarBrand';
import {Image} from "antd";
import CreateSecretOfOurServiceQuality from './CreateCarBrand';
import DeleteSecretOfOurServiceQuality from './DeleteCarBrand';
import EditSecretOfOurServiceQuality from './EditCarBrand';
const CarBrand: React.FunctionComponent = () => {
  ...
  const getAllRoles = () => {
    instance.get(ApiHelper.get("CarBrandList"),{params: {pageNumber:page,pageSize:rowsPerPage}}).then((res:any) => {
  ...
  return (
    <Fragment>
       ...
       <div className="bg-white border border-[#2c3c511a] rounded-xl flex items-baseline justify-between p-4 mb-3">
          ...
          <h3 className="text-base font-bold text-primary">برند خودرو</h3>
          <button  className='bg-[#0047bc] px-2  text-sm py-2 cursor-pointer mr-2 rounded-md   outline-none text-white' onClick={() => setShowAddModal(true)}>اضافه کردن    برند خودرو</button>
