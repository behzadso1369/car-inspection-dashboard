...
const EditCarBrand: React.FunctionComponent<
EditPieceProps
> = ({ showEditModal, setShowEditModal,secretOfOurServiceQualityId,secretOfOurServiceQualityName }) => {
  ...
  instance.put(ApiHelper.get("EditCarBrand")+ "?id=" + secretOfOurServiceQualityId,formData).then((res:any) => {
    if(res.data) {
  ...
  const  getBlogTagById = () => {
    instance.get(ApiHelper.get("GetCarBrand"),{params:{id:secretOfOurServiceQualityId}}).then((res:any) => {
        reset({
