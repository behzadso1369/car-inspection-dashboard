...
import CreateSlider from './CreateWhyWe';
import DeleteSlider from './DeleteWhyWe';
import { NavLink } from 'react-router-dom';
import CreateBlogCategory from './CreateWhyWe';
import EditBlogCategory from './EditWhyWe';
import CreateCarInspectionSrvice from './CreateWhyWe';
import DeleteCarInspectionSrvice from './DeleteWhyWe';
import EditCarInspectionSrvice from './EditWhyWe';
import {Image} from "antd";
import CreateSecretOfOurServiceQuality from './CreateWhyWe';
import DeleteSecretOfOurServiceQuality from './DeleteWhyWe';
import EditSecretOfOurServiceQuality from './EditWhyWe';
import CreateWhyWe from './CreateWhyWe';
import DeleteWhyWe from './DeleteWhyWe';
import EditWhyWe from './EditWhyWe';
...
const WhyWe: React.FunctionComponent = () => {
...
maxWidth:80,
  ...
  const cardFields = useMemo(
    () => cardFieldsFromColDefs(columnDefs, { primaryField: 't1Title' }),
    []
  );
  ...
  return (
    <Fragment>
      ...
      {showAddModal && (
        <CreateWhyWe showAddUserModal={showAddModal} setShowAddUserModal={setShowAddModal} />
     )}
     
      {showDeleteUser && (
       <DeleteWhyWe secretOfOurServiceQualityId={secretOfOurServiceQualityId} secretOfOurServiceQualityName={secretOfOurServiceQualityName} showDeleteModal={showDeleteUser} setShowDeleteModal={setShowDeleteUser}/>
     )}
       {showEditModal && (
        <EditWhyWe secretOfOurServiceQualityId={secretOfOurServiceQualityId} secretOfOurServiceQualityName={secretOfOurServiceQualityName} showEditModal={showEditModal} setShowEditModal={setShowEditModal} />
     )}
